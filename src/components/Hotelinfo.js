...
import accessibiltyData from './data/accessibility.json'
    ...
    return (
        ...
        <article id="usefulinfo">
            ...
            <section className="checklist" id="services">
                ...
                <ul>
                    {
                        servicesAndAmenitiesData.map((service) =>
                            <li>{service.saName}</li>
                        )
                    }
                </ul>
            </section>
            <section className="checklist" id="accessibility">
                ...
                <ul>
                    {
                        accessibiltyData.map((accessibility) =>
                            <li>{accessibility.aName}</li>
                        )
                    }
                </ul>
            </section>
